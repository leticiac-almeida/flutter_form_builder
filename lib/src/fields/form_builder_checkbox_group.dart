...
class FormBuilderCheckboxGroup<T> extends FormBuilderField<List<T>> {
  ...
  @override
  _FormBuilderCheckboxGroupState<T> createState() => _FormBuilderCheckboxGroupState<T>();
}

class _FormBuilderCheckboxGroupState<T> extends FormBuilderFieldState<FormBuilderCheckboxGroup<T>, List<T>> {}
