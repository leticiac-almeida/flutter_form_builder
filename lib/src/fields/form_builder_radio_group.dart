...
class FormBuilderRadioGroup<T> extends FormBuilderField<T> {
  ...
  @override
  _FormBuilderRadioGroupState<T> createState() => _FormBuilderRadioGroupState<T>();
}

class _FormBuilderRadioGroupState<T> extends FormBuilderFieldState<FormBuilderRadioGroup<T>, T> {}
