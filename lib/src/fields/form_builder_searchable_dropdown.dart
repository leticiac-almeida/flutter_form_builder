...
class FormBuilderSearchableDropdown<T> extends FormBuilderField<T> {
  ...
  @override
  _FormBuilderSearchableDropdownState<T> createState() => _FormBuilderSearchableDropdownState<T>();
}

class _FormBuilderSearchableDropdownState<T> extends FormBuilderFieldState<FormBuilderSearchableDropdown<T>, T> {}
