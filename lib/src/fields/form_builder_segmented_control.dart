...
class FormBuilderSegmentedControl<T> extends FormBuilderField<T> {
            ...
            return InputDecorator(
              ...
              child: Padding(
                ...
                child: CupertinoSegmentedControl<T>(
                  borderColor: state.enabled ? borderColor ?? theme.primaryColor : theme.disabledColor,
                  selectedColor: state.enabled ? selectedColor ?? theme.primaryColor : theme.disabledColor,
                  pressedColor: state.enabled ? pressedColor ?? theme.primaryColor : theme.disabledColor,
  ...
  @override
  _FormBuilderSegmentedControlState<T> createState() => _FormBuilderSegmentedControlState();
}

class _FormBuilderSegmentedControlState<T> extends FormBuilderFieldState<FormBuilderSegmentedControl<T>, T> {}
