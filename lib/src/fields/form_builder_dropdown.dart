          ...
          builder: (FormFieldState<T> field) {
            ...
            return InputDecorator(
              decoration: state.decoration().copyWith(
                    floatingLabelBehavior: hint == null ? decoration.floatingLabelBehavior : FloatingLabelBehavior.always,
                  ),
                    ...
                    child: DropdownButtonHideUnderline(
                      child: DropdownButton<T>(
                        ...
                        disabledHint: field.value != null
                            ? (items.firstWhere((val) => val.value == field.value, orElse: () => null)?.child ?? Text(field.value.toString()))
                            : disabledHint,
                        elevation: elevation,
                        iconSize: iconSize,
                        icon: icon,
